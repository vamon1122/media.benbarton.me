<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="media.benbarton.me.Login" %>
...
<body style="padding-top: 0px; text-align:center">
    ...
    <form runat="server" >        
        <img src="Resources/Media/Images/Web_Media/icons8-lock.svg" style="margin-top:100px; max-width:100px; display:block; margin-left: auto; margin-right:auto;" />
        <div style="margin-top:-25px; padding-right:5%; padding-left:5%;">
                <br />    
